...
export class WebViewMessageAPI {
  ...
  private pendingCallbacks: Map<number, { resolve: Function, reject: Function, timeoutId?: any }> = new Map();
  ...
  callExtension(method: string, data: any = {}, options: any = {}): Promise<any> {
